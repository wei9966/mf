...
import com.wb.service.impl.WorkServiceImpl;
...
@WebServlet(name = "SelWorkServlet",urlPatterns = "/work")
public class SelWorkServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (type){
            ...
            case 2:
                ...
                break;
            case 3:
                selAllWork(req,resp,ws);
                break;
            case 4:
                updateWork(req,resp,ws);
                break;

        }
    }

    private void updateWork(HttpServletRequest req, HttpServletResponse resp, WorkService ws)throws IOException,ServletException {
        Gson gson = new Gson();
        String obj = req.getParameter("obj");
        String id1 = req.getParameter("id");
        int  id = Integer.valueOf(id1.substring(id1.indexOf("x")+1));
        Work work = gson.fromJson(obj, Work.class);
        int i = ws.updateWork(work,id);
        System.out.println(i);
        resp.getWriter().write("work?type=3");
    }

    private void selAllWork(HttpServletRequest req, HttpServletResponse resp, WorkService ws)throws IOException,ServletException {
        ...
        PageInfo allWork = ws.getAllWork(p);
     ...
     * @param resp
     */
    private void insWork(HttpServletRequest req, HttpServletResponse resp,WorkService ws) throws IOException,ServletException {
        ...
        int i = ws.insIntoWork(work1,flag,flag1);
        System.out.println(i);
