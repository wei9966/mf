...
$(function () {
    ...
    $("#jCName>ul").on("click","li",function (e) {
        ...
        location.href="/search/searchBaoJiaByAny?cName="+v+"&flag="+flag;
        $("#jCName").hide();
    });
    /**
     * 鼠标触碰
    ...
    $("#jPName>ul").on("click","li",function (e) {
        var v=$(this).html();
        var flag=$(".flag").data("flag");
        location.href="/search/searchBaoJiaByAny?pName="+v+"&flag="+flag;
        // $.ajax()
        $("#jPName").hide();
    });
    /**
