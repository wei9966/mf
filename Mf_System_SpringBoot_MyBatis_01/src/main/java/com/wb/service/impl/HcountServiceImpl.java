...
public class HcountServiceImpl implements HcountService {
    ...
    private double getCyRseult(BaoJia b) {
        ...
        p.setdPrice(dunJiaService.getDunJia(b.getHcyType()));
    ...
    private double getFmResult(BaoJia b) {
        ...
        p.setKd(b.getHfmKs());
        p.setSize(b.getHcpSize());
        p.setdPrice(dunJiaService.getDunJia(b.getHfmType()));
        double pageSingle = CountUtil.getPageSingle(p);
        int count=b.getHcount()+CountUtil.getZount(b.getHcount());
    ...
    private double getNxResult(BaoJia b) {
        ...
        p.setKd(b.getHnxKs());
        p.setSize(b.getHcpSize());
        p.setdPrice(dunJiaService.getDunJia(b.getHnxType()));
        double pageSingle = CountUtil.getPageSingle(p);
        int count=b.getHcount()+CountUtil.getZount(b.getHcount());
